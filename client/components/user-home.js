    ...
    <div>
      ...
      <img src="./bujoavatar.gif"></img>
        <svg width="300" height="300">
            ...
            <rect x="100" y="125" width="100" height="100" fill={colorPick()} />
            
            <ellipse cx="150" cy="125" rx="50" ry="10" fill="Gainsboro" />
            <ellipse cx="150" cy="225" rx="50" ry="10" fill={colorPick()} />
            <ellipse cx="100" cy="175" rx="10" ry="50" fill={colorPick()} />
            <ellipse cx="200" cy="175" rx="10" ry="50" fill={colorPick()} />
           ...
           <ellipse cx="200" cy="145" rx="10" ry="50" fill={colorPick()} transform = "rotate(45 200 145)" />
             <ellipse cx="100" cy="145" rx="10" ry="50" fill={colorPick()} transform = "rotate(-45 100 145)" />
